...
import { Model } from "../Model/PivotCharts.Model.js";
import { Grid } from "../../Classes/Grid.Class.js";
import { Chart } from "../../Classes/Chart.Class.js";
import { Osemosys } from "../../Classes/Osemosys.Class.js";
import { GROUPNAMES, RESULTGROUPNAMES } from "../../Classes/Const.Class.js";
...
export default class PivotCharts {
    static onLoad() {
        Base.getSession()
            .then(response => {
                ...
                if (casename) {
                    ...
                    // MessageSelect.init(PivotCharts.refreshPage.bind(PivotCharts));
            ...
            .catch(error => {
                if (error.status_code == 'CaseError') {
                    ...
                    MessageSelect.activity(PivotCharts.refreshPage.bind(PivotCharts), error.casename);
                }
    ...
    static initPage(model) {
        ...
        Html.title(model.casename, model.PARAMNAMES[model.group][model.param], RESULTGROUPNAMES[model.group]);

        Html.ddlParamsAll(model.PARAMETERS);

        let $divChart1 = $('#osy-pivotChart1');
        let $divChart2 = $('#osy-pivotChart2');

        
        var daChart1 = new $.jqx.dataAdapter(model.srcChart1, { autoBind: true });
        Chart.Chart($divChart1, daChart1, "RYT", model.series);
    ...
    static initEvents(model) {
        ...
        $("#casePicker").on('click', '.selectCS', function (e) {
            ...
            PivotCharts.refreshPage(casename);
        ...
        $('#osy-params').on('change', function () {
            ...
            .then(DATA => {
                ...
                console.log('DATA ', DATA[model.param]);
                let pivotData = DataModelResult.getPivot(DATA[model.param], model.genData);
            ...
            //         console.log('PivotCharts item: ' + event.args.pivotItem + ' , selected:' + event.args );
            //    });
        ...
        $('#osy-ryt').on('change', function () {
            ...
            if (model.RYTCdata[this.value][model.case].length === 0) {
                MessageSelect.activity(RYTC.refreshPage.bind(PivotCharts), model.casename);
        ...
        $("#exportPng").on('click', function () {
            $("#osy-chartPivot").jqxChart('saveAsPNG', 'PivotCharts.png', 'https://www.jqwidgets.com/export_server/export.php');
        });
        ...
        $("#xlsAll").on('click', function (e) {
            e.preventDefault();
            $("#osy-gridPivot").jqxGrid('exportdata', 'xls', 'PivotCharts');
        });
