export const DEF = {
    ...
    AddCase: {
		...
		The structure of the UDCs is given below, where t represents the technology and n is the total number of technologies. <br/>
